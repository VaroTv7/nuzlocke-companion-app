...
export const NotesWidget: React.FC = () => {
    ...
    return (
        <div className="glass-card p-6 rounded-2xl md:col-span-2 lg:col-span-1 flex flex-col">
            <h2 className="text-xl font-bold mb-4 flex items-center gap-2 text-cyber-secondary">
                <BookOpen size={20} /> CUADERNO DE VIAJE
            </h2>
            <div className="relative">
                <textarea
                    className="w-full h-[300px] bg-black/40 border border-white/10 rounded-lg p-4 text-gray-300 resize-none focus:border-cyber-secondary focus:ring-1 focus:ring-cyber-secondary outline-none font-mono text-sm leading-relaxed"
